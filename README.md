...
| clusterGenerators | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"generator":{"passwordSpec":{"allowRepeat":true,"digits":8,"length":32,"noUpper":false,"symbolCharacters":"!@#$%","symbols":4}},"kind":"Password"},"status":{}}}` | ClusterGenerator resources keyed by resource name. |
...
| clusterGenerators.__helm_docs_example__.spec | object | `{"generator":{"passwordSpec":{"allowRepeat":true,"digits":8,"length":32,"noUpper":false,"symbolCharacters":"!@#$%","symbols":4}},"kind":"Password"}` | Resource spec rendered as-is. |
| clusterGenerators.__helm_docs_example__.status | object | `{}` | Optional resource status rendered as-is. |
| clusterPushSecrets | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"namespaceSelectors":[{"matchLabels":{"tenant":"demo"}}],"pushSecretSpec":{"data":[{"match":{"remoteRef":{"remoteKey":"providers/demo"},"secretKey":"token"}}],"refreshInterval":"1h","secretStoreRefs":[{"kind":"SecretStore","name":"documentation-placeholder"}],"selector":{"secret":{"name":"documentation-placeholder"}}}},"status":{"failedNamespaces":[]}}}` | ClusterPushSecret resources keyed by resource name. |
...
| clusterPushSecrets.__helm_docs_example__.spec | object | `{"namespaceSelectors":[{"matchLabels":{"tenant":"demo"}}],"pushSecretSpec":{"data":[{"match":{"remoteRef":{"remoteKey":"providers/demo"},"secretKey":"token"}}],"refreshInterval":"1h","secretStoreRefs":[{"kind":"SecretStore","name":"documentation-placeholder"}],"selector":{"secret":{"name":"documentation-placeholder"}}}}` | Resource spec rendered as-is. |
...
| generatorStates | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"resource":{"apiVersion":"generators.external-secrets.io/v1alpha1","kind":"Password","metadata":{"name":"documentation-placeholder","namespace":"documentation-placeholder"},"spec":{"allowRepeat":true,"digits":8,"length":32,"noUpper":false,"symbolCharacters":"!@#$%","symbols":4}},"state":{"password":"documentation-placeholder"}},"status":{"conditions":[{"status":"True","type":"Ready"}]}}}` | GeneratorState resources keyed by resource name. |
...
| generatorStates.__helm_docs_example__.spec | object | `{"resource":{"apiVersion":"generators.external-secrets.io/v1alpha1","kind":"Password","metadata":{"name":"documentation-placeholder","namespace":"documentation-placeholder"},"spec":{"allowRepeat":true,"digits":8,"length":32,"noUpper":false,"symbolCharacters":"!@#$%","symbols":4}},"state":{"password":"documentation-placeholder"}}` | Resource spec rendered as-is. |
...
| githubAccessTokens | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"appID":"12345","auth":{"privateKey":{"secretRef":{"key":"privateKey","name":"documentation-placeholder"}}},"installID":"67890","url":"https://api.github.com"},"status":{}}}` | GithubAccessToken resources keyed by resource name. |
...
| githubAccessTokens.__helm_docs_example__.spec | object | `{"appID":"12345","auth":{"privateKey":{"secretRef":{"key":"privateKey","name":"documentation-placeholder"}}},"installID":"67890","url":"https://api.github.com"}` | Resource spec rendered as-is. |
...
| grafanas | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"auth":{"token":{"key":"token","name":"documentation-placeholder"}},"serviceAccount":{"name":"documentation-placeholder","role":"Viewer"},"url":"https://grafana.example"},"status":{}}}` | Grafana resources keyed by resource name. |
...
| grafanas.__helm_docs_example__.spec | object | `{"auth":{"token":{"key":"token","name":"documentation-placeholder"}},"serviceAccount":{"name":"documentation-placeholder","role":"Viewer"},"url":"https://grafana.example"}` | Resource spec rendered as-is. |
| grafanas.__helm_docs_example__.status | object | `{}` | Optional resource status rendered as-is. |
| mfas | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"algorithm":"SHA1","length":6,"secret":{"key":"seed","name":"documentation-placeholder"},"timePeriod":30},"status":{}}}` | MFA resources keyed by resource name. |
...
| mfas.__helm_docs_example__.spec | object | `{"algorithm":"SHA1","length":6,"secret":{"key":"seed","name":"documentation-placeholder"},"timePeriod":30}` | Resource spec rendered as-is. |
...
| passwords | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"allowRepeat":true,"digits":8,"length":32,"noUpper":false,"symbolCharacters":"!@#$%","symbols":4},"status":{}}}` | Password resources keyed by resource name. |
...
| passwords.__helm_docs_example__.spec | object | `{"allowRepeat":true,"digits":8,"length":32,"noUpper":false,"symbolCharacters":"!@#$%","symbols":4}` | Resource spec rendered as-is. |
| passwords.__helm_docs_example__.status | object | `{}` | Optional resource status rendered as-is. |
| pushSecrets | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"data":[{"match":{"remoteRef":{"remoteKey":"providers/demo"},"secretKey":"token"}}],"refreshInterval":"1h","secretStoreRefs":[{"kind":"SecretStore","name":"documentation-placeholder"}],"selector":{"secret":{"name":"documentation-placeholder"}}},"status":{"conditions":[{"status":"True","type":"Ready"}]}}}` | PushSecret resources keyed by resource name. |
...
| pushSecrets.__helm_docs_example__.spec | object | `{"data":[{"match":{"remoteRef":{"remoteKey":"providers/demo"},"secretKey":"token"}}],"refreshInterval":"1h","secretStoreRefs":[{"kind":"SecretStore","name":"documentation-placeholder"}],"selector":{"secret":{"name":"documentation-placeholder"}}}` | Resource spec rendered as-is. |
...
| quayAccessTokens | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"robotAccount":"documentation-placeholder","serviceAccountRef":{"name":"documentation-placeholder"},"url":"https://quay.io"},"status":{}}}` | QuayAccessToken resources keyed by resource name. |
...
| quayAccessTokens.__helm_docs_example__.spec | object | `{"robotAccount":"documentation-placeholder","serviceAccountRef":{"name":"documentation-placeholder"},"url":"https://quay.io"}` | Resource spec rendered as-is. |
...
| sshKeys | object | `{"__helm_docs_example__":{"annotations":{},"apiVersion":"generators.external-secrets.io/v1alpha1","labels":{},"namespace":"documentation-placeholder","spec":{"comment":"documentation-placeholder","keySize":4096,"keyType":"rsa"},"status":{}}}` | SSHKey resources keyed by resource name. |
...
| sshKeys.__helm_docs_example__.spec | object | `{"comment":"documentation-placeholder","keySize":4096,"keyType":"rsa"}` | Resource spec rendered as-is. |
